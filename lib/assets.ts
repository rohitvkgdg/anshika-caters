...
export const ASSETS = {
  ...
  corporate: {
    ...
    get corporateDecor() { return getAssetUrl("Corporate event décor.webp", "corporate-images"); },
    ...
    get logoMocktail() { return getAssetUrl("Logo-branded mocktail stations.webp", "corporate-images"); },
    get seminars() { return getAssetUrl("Seminars.webp", "corporate-images"); },
    get staffServing() { return getAssetUrl("Staff in uniform serving dignitaries.webp", "corporate-images"); },
